...
CREATE TABLE IF NOT EXISTS length_adder_rules (
	id INTEGER NOT NULL, 
...
CREATE TABLE IF NOT EXISTS quote_item_options (
	id INTEGER NOT NULL, 
...
CREATE TABLE IF NOT EXISTS standard_lengths (
	id INTEGER NOT NULL, 
	material_code VARCHAR NOT NULL, 
...
INSERT INTO "options" ("id","name","description","price","price_type","category","excluded_products","product_families","choices","adders","rules") VALUES (1,'NEMA 4 Enclosure','10" x 8" x 4" NEMA 4 metal enclosure for receiver',0.0,'fixed','Accessories',NULL,'LS8000/2','["Yes", "No"]','{"Yes": 420, "No": 0}',NULL),
 ...
 (38,'Material','Defines the wetted materials of the probe and housing.',0.0,'fixed','Material',NULL,'LS2000','[{"code": "S", "display_name": "S - 316 Stainless Steel"}, {"code": "H", "display_name": "H - Halar Coated"}, {"code": "TS", "display_name": "TS - Teflon Sleeve"}, {"code": "T", "display_name": "T - Teflon"}, {"code": "U", "display_name": "U - UHMWPE"}, {"code": "CPVC", "display_name": "CPVC"}, {"code": "HC", "display_name": "HC - Hastelloy C-276 (Consult Factory)"}, {"code": "HB", "display_name": "HB - Hastelloy B (Consult Factory)"}, {"code": "TI", "display_name": "TI - Titanium (Consult Factory)"}, {"code": "A20", "display_name": "A20 - Alloy 20 (Consult Factory)"}, {"code": "M", "display_name": "M - Monel (Consult Factory)"}, {"code": "I", "display_name": "I - Inconel (Consult Factory)"}]','{"S": 0.0, "H": 110.0, "TS": 110.0, "T": 60.0, "U": 20.0, "CPVC": 400.0, "HC": 0.0, "HB": 0.0, "TI": 0.0, "A20": 0.0, "M": 0.0, "I": 0.0}',NULL),
 ...
 (42,'Material','Probe material selection (including exotic metals)',0.0,'fixed','Material',NULL,'LS7000/2','["H", "TS", "A", "HC", "HB", "TT", {"code": "S", "display_name": "S - 316 Stainless Steel"}]','{"H": 0, "TS": 0, "A": 0, "HC": 0, "HB": 0, "TT": 0}',NULL),
 ...
 (46,'Material','Probe material selection (including exotic metals)',0.0,'fixed','Material',NULL,'FS10000','["S", "A", "HC", "HB", "TT", {"code": "CPVC", "display_name": "CPVC - CPVC"}, {"code": "U", "display_name": "U - Uranus B6"}, {"code": "H", "display_name": "H - Halar"}]','{"S": 0, "A": 0, "HC": 0, "HB": 0, "TT": 0}',NULL),
 (47,'Material','Probe material selection (including exotic metals)',0.0,'fixed','Material',NULL,'LS7500','["S", "A", "HC", "HB", "TT", {"code": "U", "display_name": "U - Uranus B6"}]','{"S": 0, "A": 0, "HC": 0, "HB": 0, "TT": 0}',NULL),
 (48,'Material','Probe material selection (including exotic metals)',0.0,'fixed','Material',NULL,'LS8500','["S", "A", "HC", "HB", "TT", {"code": "TS", "display_name": "TS - Teflon Sleeve"}]','{"S": 0, "A": 0, "HC": 0, "HB": 0, "TT": 0}',NULL),
