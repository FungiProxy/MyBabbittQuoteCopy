...
from src.core.models import ProductFamily, SparePart  # Make sure SparePart is imported
from src.core.services.database_populate import (
    populate_from_price_list,
