    ...
    try:
        ...
        materials = [
            Material(
                ...
                description="Standard 316SS probe",
                base_length=10.0,
                length_adder_per_inch=0,
            ...
            Material(
                ...
                has_nonstandard_length_surcharge=False,
                nonstandard_length_surcharge=0.0,
                base_price_adder=80.0,
            ),
            Material(
                code="CPVC",
                name="CPVC Blind End",
                description="CPVC blind end probe",
                base_length=4.0,
                length_adder_per_inch=50.0,
                length_adder_per_foot=0,
                has_nonstandard_length_surcharge=False,
