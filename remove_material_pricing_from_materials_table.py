...
def remove_material_pricing_from_materials_table():
    ...
    try:
        ...
        for material in materials:
            ...
            print(f'    Current length_adder_per_inch: ${material.length_adder_per_inch}')
            print(f'    Current length_adder_per_foot: ${material.length_adder_per_foot}')
            print(f'    Current nonstandard_length_surcharge: ${material.nonstandard_length_surcharge}')
