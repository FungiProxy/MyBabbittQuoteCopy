...
def check_seeding_files():
    ...
    seeding_files = [
        ...
        (
            "scripts/data/init/init_business_config.py",
            "Business configuration initialization",
        ),
        ...
        (
            "scripts/data/seeds/options/seed_ls7000_2_connections.py",
            "LS7000_2 connections",
        ),
        ("scripts/data/seeds/options/seed_ls7000_connections.py", "LS7000 connections"),
        (
            "scripts/data/seeds/options/seed_ls8000_2_connections.py",
            "LS8000_2 connections",
        ),
        ...
        (
            "scripts/data/seeds/options/seed_presence_absence_families.py",
            "Presence/absence families",
        ),
    ]
