...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_product_families_category'),
        'product_families',
        ['category'],
        unique=False,
    )
    op.create_index(
        op.f('ix_product_families_id'), 'product_families', ['id'], unique=False
    )
    op.create_index(
        op.f('ix_product_families_name'), 'product_families', ['name'], unique=False
    )
    op.create_table(
        'standard_lengths',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f('ix_standard_lengths_id'), 'standard_lengths', ['id'], unique=False
    )
    op.create_index(
        op.f('ix_standard_lengths_material_code'),
        'standard_lengths',
        ['material_code'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_material_availability_id'),
        'material_availability',
        ['id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_material_availability_material_code'),
        'material_availability',
        ['material_code'],
        unique=False,
    )
    op.create_index(
        op.f('ix_material_availability_product_type'),
        'material_availability',
        ['product_type'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_spare_parts_category'), 'spare_parts', ['category'], unique=False
    )
    op.create_index(op.f('ix_spare_parts_id'), 'spare_parts', ['id'], unique=False)
    op.create_index(
        op.f('ix_spare_parts_part_number'), 'spare_parts', ['part_number'], unique=False
    )
    op.create_table(
        'voltage_options',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f('ix_quote_item_options_id'), 'quote_item_options', ['id'], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f('ix_product_variants_model_number'), table_name='product_variants'
    )
    ...
    op.drop_index(
        op.f('ix_material_availability_product_type'),
        table_name='material_availability',
    )
    op.drop_index(
        op.f('ix_material_availability_material_code'),
        table_name='material_availability',
    ...
    op.drop_index(
        op.f('ix_material_availability_id'), table_name='material_availability'
    )
    op.drop_table('material_availability')
    op.drop_table('connection_options')
    op.drop_table('cable_length_options')
    op.drop_index(
        op.f('ix_standard_lengths_material_code'), table_name='standard_lengths'
    )
