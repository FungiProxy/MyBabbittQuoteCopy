...
def update_exotic_metals_availability():
    ...
    try:
        ...
        print(f"Updating exotic metals availability for all families:")
        ...
        for family in product_families:
            ...
            if material_option:
                ...
                if changes_made:
                    ...
                    print(f"  ✅ Updated {family.name}: {len(current_choices)} → {len(updated_choices)} choices")
                else:
...
def verify_updated_availability():
    ...
    try:
        ...
        print(f"Verifying exotic metals availability:")
...
def main():
    ...
    response = input("\nUpdate exotic metals availability for all families? (y/N): ").strip().lower()
    if response != 'y':
