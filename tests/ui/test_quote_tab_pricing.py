...
from src.core.models import ConnectionOption, Product
from src.core.models.configuration import Configuration
from src.ui.views.quote_tab import QuoteTab

Product = namedtuple("Product", ["id", "name", "base_price", "base_length", "category"])
Variant = namedtuple(
    "Variant", ["model_number", "base_price", "material", "voltage", "length"]
)
