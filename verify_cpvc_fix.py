...
def verify_cpvc_fix():
    ...
    try:
            ...
            if cpvc_found:
                ...
                if base_variant:
                    ...
                    if abs(applied_adder - 400.0) < 0.01:
                        print(f"  ✅ CPVC pricing correct")
                    else:
                        print(f"  ❌ CPVC pricing incorrect (expected $400.00)")
        ...
        for family_name in families_without_cpvc:
            ...
            if cpvc_found:
                print(f"  ❌ CPVC incorrectly available!")
            else:
                print(f"  ✅ CPVC correctly not available")
