    ...
    try:
        ...
        for code in exotic_codes:
            ...
            if material:
                ...
                print(f"      Nonstandard surcharge: ${material.nonstandard_length_surcharge}")
            else:
        ...
        print(f"✅ Standard lengths created for exotic materials")
        print(f"✅ All exotic metals integrated into materials system")
