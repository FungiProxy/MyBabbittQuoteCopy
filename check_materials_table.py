...
def check_materials_table():
    ...
    try:
        ...
        for m in materials:
            print(
                f'  {m.code}: {m.name} - Base Length: {m.base_length}", Length Adder: ${m.length_adder_per_foot}/ft, Non-standard: ${m.nonstandard_length_surcharge}'
            )
        ...
        exotic_metals = [
            {
                ...
                'name': 'Alloy 20',
                'base_length': 10.0,
                'length_adder_per_foot': 0,
                'nonstandard_length_surcharge': 0,
            },
            {
                'code': 'HB',
                'name': 'Hastelloy-B',
        ...
        missing_metals = [
            metal for metal in exotic_metals if metal['code'] not in existing_codes
        ]
