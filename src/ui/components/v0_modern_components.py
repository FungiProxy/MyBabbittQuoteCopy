...
Adapted from v0ui for seamless integration with existing codebase
"""

from PySide6.QtWidgets import (QPushButton, QLineEdit, QTextEdit, QComboBox, 
                               QLabel, QWidget, QVBoxLayout, QHBoxLayout,
                               QFrame, QScrollArea, QGroupBox, QSpinBox)
from PySide6.QtCore import Qt, Signal, QPropertyAnimation, QEasingCurve, QRect, QTimer
from PySide6.QtGui import QFont, QPainter, QColor, QPen, QBrush

# Import styles from our modern styles module
from .v0_modern_styles import COLORS, FONTS, SPACING, RADIUS, get_button_style, get_input_style
...
class ModernButton(QPushButton):
    ...
    def __init__(self, text="", button_type="primary", parent=None):
        ...
        self.setFont(QFont(FONTS['family'], FONTS['sizes']['base'], FONTS['weights']['medium']))
...
class ModernLineEdit(QLineEdit):
    ...
    def __init__(self, placeholder="", parent=None):
        ...
        self.setFont(QFont(FONTS['family'], FONTS['sizes']['lg']))
        self.setStyleSheet(get_input_style())

class ModernComboBox(QComboBox):
    """Modern combo box component"""
...
class SearchBar(QWidget):
    ...
    def setup_ui(self, placeholder):
        ...
        self.search_input = ModernLineEdit(placeholder)
