...
class QuoteCreationPageRedesign(QWidget):
    ...
    def _on_product_configured(self, config_data: Dict):
        ...
        try:
            ...
            QMessageBox.critical(self, 'Error', f'Failed to add product to quote: {e!s}')
    ...
    def _edit_item(self, row: int):
        ...
        if 0 <= row < len(self.current_quote['items']):
            ...
            ConfigurationWizard(quote_item['config_data']['product_data'], self)
    ...
    def _save_draft(self):
        ...
        try:
            ...
            QMessageBox.critical(self, 'Error', f'Failed to save quote: {e!s}')
    ...
    def _generate_pdf(self):
        ...
        try:
            ...
            QMessageBox.critical(self, 'Error', f'Failed to generate PDF: {e!s}')
    ...
    def _send_quote(self):
        ...
        try:
            ...
            QMessageBox.critical(self, 'Error', f'Failed to send quote: {e!s}')
