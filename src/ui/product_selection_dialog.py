...
class ProductSelectionDialog(QDialog):
    ...
    def _setup_core_options(self, form_layout: QFormLayout, product: dict):
        ...
        # Get voltage options for this product family - ADD VOLTAGE FIRST
        ...
        # Get material options for this product family - ADD MATERIAL SECOND
        try:
        ...
        for choice in material_choices:
            if isinstance(choice, dict):
                ...
                material_combo.addItem(
                    choice.get("display_name", ""), choice.get("code", "")
                )
            else:
        ...
        def on_material_changed():
            ...
            if material_base_length is not None:
                ...
                if spin_widget and edit_widget:
                    ...
                    logger.debug(
                        f'Auto-set probe length to {length_value}" for material {value}'
                    )
