...
class ConfigurationService:
    ...
    def start_configuration(self, product_family_id: int, product_family_name: str, base_product_info: dict) -> Configuration:
        ...
        self.current_config.selected_options['Length'] = base_product_info.get('base_length', 0.0)
    ...
    def calculate_price(self) -> float:
        ...
        product_id = config.base_product.get('id') # This is family id, needs to be variant id
