...
from src.core.models import StandardLength, Option
...
def fix_standard_lengths():
    ...
    try:
        ...
        deleted_s = session.query(StandardLength).filter(StandardLength.material_code == 'S').delete()
        ...
        existing_h_lengths = session.query(StandardLength).filter(StandardLength.material_code == 'H').all()
        ...
        existing_lengths = [sl.length for sl in session.query(StandardLength).filter(StandardLength.material_code == 'H').all()]
