...
def analyze_database():
    ...
    if "options" in tables:
        ...
        for category, cat_name, families, count in option_categories:
            if category:
    ...
    if "material_options" in tables and "options" in tables:
        ...
        print(f"  OVERLAP DETECTED: Both tables contain material data")
    ...
    if "voltage_options" in tables and "options" in tables:
        ...
        print(f"  OVERLAP DETECTED: Both tables contain voltage data")
