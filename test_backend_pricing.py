...
def test_backend_pricing():
    db = SessionLocal()
    try:
        print("=== TESTING BACKEND PRICING LOGIC ===\n")
        ...
        print(f"Testing materials: {all_materials}")
        ...
        for material_code in all_materials:
            ...
            if abs(applied_adder - expected_adder) < 0.01:
                print(f"  ✅ CORRECT: Adder matches expected value")
            else:
                print(f"  ❌ INCORRECT: Adder does not match expected value")
