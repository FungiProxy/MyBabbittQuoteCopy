...
def analyze_relationships():
    ...
    try:
        ...
        if 'product_family_options' in tables:
            ...
            print(f"Total relationships in product_family_options: {len(relationships)}")
...
def check_for_voltage_options():
    ...
    try:
        ...
        voltage_options = db.query(Option).filter(
...
def check_for_connection_options():
    ...
    try:
        ...
        connection_options = db.query(Option).filter(
